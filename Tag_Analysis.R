...
# read in data
data_full <- read.csv('/nfs/home/lcu1428/z/400_proj/data_full.csv')
data_engineer <- read.csv('/nfs/home/lcu1428/z/400_proj/data_engineer.csv')
data_driver <- read.csv('/nfs/home/lcu1428/z/400_proj/data_driver.csv')
...
write_csv(skill_money_eng_df,'/nfs/home/lcu1428/z/400_proj/skill_money_eng_state.csv')
...
write_csv(skill_fill_eng_df,'/nfs/home/lcu1428/z/400_proj/skill_fill_eng_state.csv')
...
summary(num_tags) # an driver job posting would have on average 10 tags
...
write_csv(skill_money_dri_df,'/nfs/home/lcu1428/z/400_proj/skill_money_dri_state.csv')
...
write_csv(skill_fill_dri_df,'/nfs/home/lcu1428/z/400_proj/skill_fill_dri_state.csv')
