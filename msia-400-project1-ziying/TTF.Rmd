...
library(ggplot2)
# read data
data_full <- read_csv('MSIA-400-code/MSIA400DATA/Manu_data_200000.csv')
...
full.den.driver.model <- lm(time_to_fill ~ salary + region + safety + diploma + transportation + cust.serv + training + commercial + warehouse + quarter1 + quarter2 + quarter3 + salary.bucket, data=denver.driver)
summary(full.den.driver.model)
plot(full.den.driver.model)
```
